const chart = document.getElementById('chartArea') as HTMLElement;
const shopSelector = document.getElementById('shopSelector') as HTMLSelectElement;
...
function switchShop(shop: string) {
